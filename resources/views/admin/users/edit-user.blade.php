...
@section('dashboard-title', 'Edit Pengguna: ' . $user->name)
@section('dashboard-desc', 'Perbarui detail informasi pengguna.')
...
@section('main')
    <section class="max-w-4xl">
        ...
        <div class="rounded-lg bg-white p-6 shadow-md">
            {{-- Form for updating the user. Uses PUT method spoofing. --}}
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <input type="text" name="nip" id="nip"
                            ...
                            placeholder="Contoh: 12345678" value="{{ old('nip', $user->nip) }}" required>
                        @error('nip')
                    ...
                    <div>
                        ...
                        <select id="division" name="division"
                            ...
                            @foreach ($divisions as $division)
                                <option value="{{ $division }}" {{ old('division', $user->division) == $division ? 'selected' : '' }}>
                    ...
                    <div class="sm:col-span-2">
                        <h3 class="mb-4 text-lg font-semibold text-gray-900">Ubah Password (Opsional)</h3>
                    </div>

                    {{-- Password --}}
                    <div>
                        <label for="password" class="mb-2 block text-sm font-medium text-gray-900">Password Baru</label>
                    ...
                    {{-- Confirm Password --}}
                    <div>
                        <label for="password_confirmation" class="mb-2 block text-sm font-medium text-gray-900">Konfirmasi Password Baru</label>
